...
$user = UserController::getDetails();
?>
<html lang="en">
            ...
            <main>
                ...
                <header>
                    ...
                    <div class="user">
                        ...
                        <img src="./assets/images/users/<?= $user['image'] ?>" class="user-image" alt="your image">
                        <span> <i class="fas fa-angle-down" aria-hidden="true"></i> </span>
                    </div>
                    <ul class="dropdown">
                        <li>
                            <div class="litle-info">
                                <img src="./assets/images/users/<?= $user['image'] ?>" class="user-image" alt="my image">
                                <div class="info">
